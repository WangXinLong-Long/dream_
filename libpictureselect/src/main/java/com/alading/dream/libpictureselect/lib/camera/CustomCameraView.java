package com.alading.dream.libpictureselect.lib.camera;
...
import com.alading.dream.libpictureselect.lib.PictureMediaScannerConnection;
import com.alading.dream.libpictureselect.lib.camera.listener.CameraListener;
import com.alading.dream.libpictureselect.lib.camera.listener.CaptureListener;
import com.alading.dream.libpictureselect.lib.camera.listener.ClickListener;
import com.alading.dream.libpictureselect.lib.camera.listener.ImageCallbackListener;
import com.alading.dream.libpictureselect.lib.camera.listener.TypeListener;
import com.alading.dream.libpictureselect.lib.camera.view.CaptureLayout;
...
public class CustomCameraView extends RelativeLayout {
    ...
    public void initView() {
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void takePictures() {
                ...
                mCameraView.takePicture(imageOutFile,
                        ...
                        new VideoCapture.OnVideoSavedListener() {
                            ...
                            public void onError(VideoCapture.UseCaseError useCaseError, String message, @Nullable Throwable cause) {
                                if (mCameraListener != null) {
                                    mCameraListener.onError(2222, message, cause);
                                }
                            }
                        });
            }
     ...
     * 拍照回调
     */
    private static class MyImageResultCallback implements ImageCapture.OnImageSavedListener {
        ...
        @Override
        public void onError(@NonNull ImageCapture.UseCaseError useCaseError, @NonNull String message, @Nullable Throwable exception) {
            if (mCameraListenerReference.get() != null) {
                mCameraListenerReference.get().onError(/*exception.getImageCaptureError()*/2222, exception.getMessage(), exception.getCause());
            }
        }
    }
